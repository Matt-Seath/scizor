...
ASX_200_SYMBOLS = [
    ...
    {"symbol": "ANZ", "name": "Australia and New Zealand Banking Group Ltd", "sector": "Financials"},
    {"symbol": "WBC", "name": "Westpac Banking Corp", "sector": "Financials"},
    {"symbol": "NAB", "name": "National Australia Bank Ltd", "sector": "Financials"},
    {"symbol": "WES", "name": "Wesfarmers Ltd", "sector": "Consumer Staples"},
    {"symbol": "MQG", "name": "Macquarie Group Ltd", "sector": "Financials"},
    {"symbol": "TLS", "name": "Telstra Group Ltd", "sector": "Communication Services"},
    {"symbol": "WOW", "name": "Woolworths Group Ltd", "sector": "Consumer Staples"},
    {"symbol": "FMG", "name": "Fortescue Ltd", "sector": "Materials"},
    {"symbol": "RIO", "name": "Rio Tinto Ltd", "sector": "Materials"},
    {"symbol": "TCL", "name": "Transurban Group", "sector": "Industrials"},
    {"symbol": "COL", "name": "Coles Group Ltd", "sector": "Consumer Staples"},
    {"symbol": "WDS", "name": "Woodside Energy Group Ltd", "sector": "Energy"},
    {"symbol": "STO", "name": "Santos Ltd", "sector": "Energy"},
    {"symbol": "ALL", "name": "Aristocrat Leisure Ltd", "sector": "Consumer Discretionary"},
    {"symbol": "XRO", "name": "Xero Ltd", "sector": "Technology"},
    {"symbol": "REA", "name": "REA Group Ltd", "sector": "Communication Services"},
    {"symbol": "QAN", "name": "Qantas Airways Ltd", "sector": "Industrials"},
    
    # ASX 21-50 (Tier 2)
    {"symbol": "GMG", "name": "Goodman Group", "sector": "Real Estate"},
    {"symbol": "JHX", "name": "James Hardie Industries plc", "sector": "Materials"},
    {"symbol": "IAG", "name": "Insurance Australia Group Ltd", "sector": "Financials"},
    {"symbol": "CPU", "name": "Computershare Ltd", "sector": "Technology"},
    {"symbol": "WOR", "name": "WorleyParsons Ltd", "sector": "Energy"},
    {"symbol": "ALX", "name": "Atlas Arteria", "sector": "Industrials"},
    {"symbol": "NCM", "name": "Newcrest Mining Ltd", "sector": "Materials"},
    {"symbol": "MIN", "name": "Mineral Resources Ltd", "sector": "Materials"},
    {"symbol": "EDV", "name": "Endeavour Group Ltd", "sector": "Consumer Staples"},
    {"symbol": "COH", "name": "Cochlear Ltd", "sector": "Health Care"},
    {"symbol": "AZJ", "name": "Aurizon Holdings Ltd", "sector": "Industrials"},
    {"symbol": "QBE", "name": "QBE Insurance Group Ltd", "sector": "Financials"},
    {"symbol": "APA", "name": "APA Group", "sector": "Utilities"},
    {"symbol": "ASX", "name": "ASX Ltd", "sector": "Financials"},
    {"symbol": "AGL", "name": "AGL Energy Ltd", "sector": "Utilities"},
    {"symbol": "ORG", "name": "Origin Energy Ltd", "sector": "Utilities"},
    {"symbol": "ALD", "name": "Ampol Ltd", "sector": "Energy"},
    {"symbol": "TAH", "name": "Tabcorp Holdings Ltd", "sector": "Consumer Discretionary"},
    {"symbol": "CAR", "name": "CAR Group Ltd", "sector": "Communication Services"},
    {"symbol": "CWN", "name": "Crown Resorts Ltd", "sector": "Consumer Discretionary"},
    {"symbol": "IPL", "name": "Incitec Pivot Ltd", "sector": "Materials"},
    {"symbol": "LLC", "name": "Lendlease Corp Ltd", "sector": "Real Estate"},
    {"symbol": "CCL", "name": "Coca-Cola Amatil Ltd", "sector": "Consumer Staples"},
    {"symbol": "BSL", "name": "BlueScope Steel Ltd", "sector": "Materials"},
    {"symbol": "AMP", "name": "AMP Ltd", "sector": "Financials"},
    {"symbol": "BAP", "name": "Bapcor Ltd", "sector": "Consumer Discretionary"},
    {"symbol": "BXB", "name": "Brambles Ltd", "sector": "Industrials"},
    {"symbol": "CHC", "name": "Charter Hall Group", "sector": "Real Estate"},
    {"symbol": "DEG", "name": "De Grey Mining Ltd", "sector": "Materials"},
    {"symbol": "DXS", "name": "Dexus", "sector": "Real Estate"},
    
    # ASX 51-100 (Tier 3)
    {"symbol": "S32", "name": "South32 Ltd", "sector": "Materials"},
    {"symbol": "SHL", "name": "Sonic Healthcare Ltd", "sector": "Health Care"},
    {"symbol": "RMD", "name": "ResMed Inc", "sector": "Health Care"},
    {"symbol": "WTC", "name": "WiseTech Global Ltd", "sector": "Technology"},
    {"symbol": "EVN", "name": "Evolution Mining Ltd", "sector": "Materials"},
    {"symbol": "ILU", "name": "Iluka Resources Ltd", "sector": "Materials"},
    {"symbol": "BOQ", "name": "Bank of Queensland Ltd", "sector": "Financials"},
    {"symbol": "BEN", "name": "Bendigo and Adelaide Bank Ltd", "sector": "Financials"},
    {"symbol": "IGO", "name": "IGO Ltd", "sector": "Materials"},
    {"symbol": "OZL", "name": "Oz Minerals Ltd", "sector": "Materials"},
    {"symbol": "PME", "name": "Pro Medicus Ltd", "sector": "Health Care"},
    {"symbol": "RHC", "name": "Ramsay Health Care Ltd", "sector": "Health Care"},
    {"symbol": "SEK", "name": "Seek Ltd", "sector": "Communication Services"},
    {"symbol": "TPG", "name": "TPG Telecom Ltd", "sector": "Communication Services"},
    {"symbol": "NXT", "name": "NEXTDC Ltd", "sector": "Technology"},
    {"symbol": "DMP", "name": "Domino's Pizza Enterprises Ltd", "sector": "Consumer Discretionary"},
    {"symbol": "TWE", "name": "Treasury Wine Estates Ltd", "sector": "Consumer Staples"},
    {"symbol": "SYD", "name": "Sydney Airport", "sector": "Industrials"},
    {"symbol": "MEL", "name": "Melbourne Airport", "sector": "Industrials"},
